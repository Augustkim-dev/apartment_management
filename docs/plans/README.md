...
7. **[Phase 7: 환경설정 관리 시스템](./007_환경설정_관리_시스템.md)**
   - 하드코딩된 값 설정 관리
   - 관리자 설정 UI

8. **[Phase 8: 호실별 청구서 수정 기능](./008_호실별_청구서_수정_기능.md)**
   - 비율 재계산 / 직접 입력 모드
   - 감사 추적 (bill_history)

9. **[Phase 9: 이사 정산 - 중도 퇴거/입주 분할 청구](./009_이사정산_중도퇴거_입주_분할청구.md)**
   - 월 중간 퇴거/입주 시 분할 청구
   - 직전 3개월 평균 기반 추정 정산
   - 입주자(tenant) 이력 관리
...
- [x] Phase 1: MySQL 연결 및 테이블 생성
- [x] Phase 2: PDF/Excel 파싱 API
- [x] Phase 3: 계산 엔진 구현
- [x] Phase 4: 대시보드 UI 개발
- [x] Phase 5: 인증 시스템 구현
- [x] Phase 6: Vercel 배포
- [x] Phase 7: 환경설정 관리 시스템
- [x] Phase 8: 호실별 청구서 수정 기능
- [ ] Phase 9: 이사 정산 - 중도 퇴거/입주 분할 청구
